...
def make_plot():
    ...
    #---------------------------------------------------------------------------
    fig_name = f'level_statistics_tgbc_L{L}_N{N}_{U_}.pdf'
    ...
    data_dir = Path('/afs/physnet.uni-hamburg.de/users/zoq_t/ftheel/'
                    'Schreibtisch/project_ahm2/level_statistics/data_tgbc')
    ...
    eval_1 = read_in_data(f'L{L}_N{N}_thpi_0_0_histogramData.m')
    eval_2 = read_in_data(f'L{L}_N{N}_thpi_0_2_histogramData.m')
    eval_3 = read_in_data(f'L{L}_N{N}_thpi_0_5_histogramData.m')
    eval_4 = read_in_data(f'L{L}_N{N}_thpi_0_8_histogramData.m')
    eval_5 = read_in_data(f'L{L}_N{N}_thpi_1_0_histogramData.m')
