...
def get_theta_str(theta: Union[float, Sequence[float]]) -> str:
    """
    Converts theta-value to string used for storing.

    Args:
        theta (float or Sequence): value of statistical pahse
...
def get_J_str(J: Union[float, Sequence[float]]) -> str:
    """
    Converts J-value to string used for storing.

    Args:
        J (float or Sequence): value of hopping parameter
...
def get_U_str(U: Union[float, Sequence[float]]) -> str:
    """
    Converts U-value to string used for storing.

    Args:
        theta (float or Sequence): value of onsite interaction
...
def get_path_basis(
    ...
    Args:
        ...
        J (float or Sequence): hopping parameter
        U (float or Sequence): on-site interaction
        theta (float or Sequence): statistical angle
